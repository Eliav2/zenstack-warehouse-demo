...
export function useCreateRole(
    options?: Omit<UseMutationOptions<Role | undefined, DefaultError, Prisma.RoleCreateArgs>, 'mutationFn'>,
...
export function useCreateManyRole(
    options?: Omit<UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.RoleCreateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateRole(
    options?: Omit<UseMutationOptions<Role | undefined, DefaultError, Prisma.RoleUpdateArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManyRole(
    options?: Omit<UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.RoleUpdateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpsertRole(
    options?: Omit<UseMutationOptions<Role | undefined, DefaultError, Prisma.RoleUpsertArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteRole(
    options?: Omit<UseMutationOptions<Role | undefined, DefaultError, Prisma.RoleDeleteArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteManyRole(
    options?: Omit<UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.RoleDeleteManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
