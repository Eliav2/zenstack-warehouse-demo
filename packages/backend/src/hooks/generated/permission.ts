...
export function useCreatePermission(
    options?: Omit<UseMutationOptions<Permission | undefined, DefaultError, Prisma.PermissionCreateArgs>, 'mutationFn'>,
    ...
    const mutation = {
        ...
        mutateAsync: async <T extends Prisma.PermissionCreateArgs>(
            ...
            options?: Omit<
                UseMutationOptions<
                    CheckSelect<T, Permission, Prisma.PermissionGetPayload<T>> | undefined,
                    DefaultError,
            ...
            return (await _mutation.mutateAsync(args, options as any)) as
                | CheckSelect<T, Permission, Prisma.PermissionGetPayload<T>>
                | undefined;
        },
    };
    return mutation;
...
export function useCreateManyPermission(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.PermissionCreateManyArgs>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
>(
    ...
    return useModelQuery<TQueryFnData, TData, TError>(
        'Permission',
        `${endpoint}/permission/findUnique`,
        args,
        options,
        fetch,
        optimisticUpdate,
...
export function useUpdatePermission(
    options?: Omit<UseMutationOptions<Permission | undefined, DefaultError, Prisma.PermissionUpdateArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManyPermission(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.PermissionUpdateManyArgs>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useUpsertPermission(
    options?: Omit<UseMutationOptions<Permission | undefined, DefaultError, Prisma.PermissionUpsertArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
        ...
        mutateAsync: async <T extends Prisma.PermissionUpsertArgs>(
            ...
            options?: Omit<
                UseMutationOptions<
                    CheckSelect<T, Permission, Prisma.PermissionGetPayload<T>> | undefined,
                    DefaultError,
                    Prisma.SelectSubset<T, Prisma.PermissionUpsertArgs>
                >,
                'mutationFn'
            >,
        ) => {
...
export function useDeletePermission(
    options?: Omit<UseMutationOptions<Permission | undefined, DefaultError, Prisma.PermissionDeleteArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteManyPermission(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.PermissionDeleteManyArgs>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useGroupByPermission<
    TArgs extends Prisma.PermissionGroupByArgs,
    ...
    TQueryFnData = {} extends InputErrors
        ? Array<
              PickEnumerable<Prisma.PermissionGroupByOutputType, TArgs['by']> & {
...
>(
    args: Prisma.SelectSubset<
        TArgs,
        Prisma.SubsetIntersection<TArgs, Prisma.PermissionGroupByArgs, OrderByArg> & InputErrors
    >,
    options?: Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useSuspenseGroupByPermission<
    TArgs extends Prisma.PermissionGroupByArgs,
    HasSelectOrTake extends Prisma.Or<
        Prisma.Extends<'skip', Prisma.Keys<TArgs>>,
        Prisma.Extends<'take', Prisma.Keys<TArgs>>
...
export function useCountPermission<
    ...
    TError = DefaultError,
>(
    args?: Prisma.SelectSubset<TArgs, Prisma.PermissionCountArgs>,
    options?: Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>,
) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>(
        'Permission',
        `${endpoint}/permission/count`,
        args,
        options,
        fetch,
    );
